...
import 'package:ditonton/domain/models/movie/movie_detail_model.dart';
import 'package:ditonton/domain/models/movie/movie_model.dart';
import 'package:ditonton/domain/repositories/movie_repository_impl.dart';
...
void main() {
  ...
  group('Popular Movies', () {
    test('should return movie list when call to domain source is success',
        () async {
      // arrange
  ...
  group('Top Rated Movies', () {
    test('should return movie list when call to domain source is successful',
        () async {
      // arrange
  ...
  group('Get Movie Detail', () {
    ...
    test(
        'should return Movie domain when the call to remote domain source is successful',
        () async {
      // arrange
  ...
  group('Get Movie Recommendations', () {
    ...
    test('should return domain (movie list) when the call is successful',
        () async {
      // arrange
  ...
  group('get watchlist status', () {
    test('should return watch status whether domain is found', () async {
      // arrange
      final tId = 1;
